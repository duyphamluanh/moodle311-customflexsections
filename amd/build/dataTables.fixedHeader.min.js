...
*/
(function(e){"function"===typeof define&&define.amd?define(["jquery","format_flexsections/jquery.dataTables"],function(g){return e(g,window,document)}):"object"===typeof exports?module.exports=function(g,h){g||(g=window);h&&h.fn.dataTable||(h=require("format_flexsections/jquery.dataTables")(g,h).$);return e(h,g,g.document)}:e(jQuery,window,document)})(function(e,g,h,p){var k=e.fn.dataTable,r=0,l=function(a,b){if(!(this instanceof l))throw"FixedHeader must be initialised with the 'new' keyword.";!0===b&&(b={});a=new k.Api(a);this.c=e.extend(!0,
